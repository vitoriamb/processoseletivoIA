...
Com 14.410 parâmetros e 98,54% de acurácia, o modelo já atende bem ao objetivo do desafio. A quantização Dynamic Range reduziu o tamanho do arquivo em cerca de **90% em relação ao `.h5` original** (≈208 KB → ≈20,49 KB), com impacto praticamente nulo na acurácia.